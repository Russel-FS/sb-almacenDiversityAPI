...
-- Rubro de prueba
INSERT INTO Rubros (Nombre, Code) VALUES ('Rubro Test', 'RUBRO_TEST');

-- Rol de prueba
INSERT INTO Roles (Nombre_Rol, Descripcion) VALUES ('TestRol', 'Rol para pruebas');

-- Usuario de prueba
INSERT INTO Usuarios (Nombre_Usuario, Email, Nombre_Completo, ID_Rol, ID_Rubro, Contraseña)
VALUES ('usuario_test', 'test@email.com', 'Usuario Test', 1, 1, '123456');

-- Proveedor de prueba
INSERT INTO Proveedores (Razon_Social, RUC, Direccion, Telefono, Email)
VALUES ('Proveedor Test', '12345678901', 'Direccion Test', '999999999', 'proveedor@test.com');

-- Categoría de prueba
INSERT INTO Categorias (ID_Rubro, Nombre_Categoria, Descripcion, created_by)
VALUES (1, 'Categoria Test', 'Descripcion Categoria', 1);
...
VALUES ('PROD001', 'Producto Test', 'Descripcion Producto', 1, 10.00, 15.00, 100, 10, 200, 1);